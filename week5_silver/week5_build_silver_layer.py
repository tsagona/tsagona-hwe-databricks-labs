...
bronze_reviews = spark.readStream \
    ...
    .load("s3a://hwe-fall-2025/tsagona/bronze/reviews")
bronze_reviews.createOrReplaceTempView("bronze_reviews")

bronze_customers = spark.read.format("parquet").load("s3a://hwe-fall-2025/tsagona/bronze/customers")
...
streaming_query = silver_data.writeStream \
    .format("parquet") \
    .option("path", "s3a://hwe-fall-2025/tsagona/silver/reviews/") \
