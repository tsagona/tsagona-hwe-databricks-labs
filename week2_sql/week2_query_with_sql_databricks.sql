...
-- MAGIC %md
-- MAGIC # Week 2 Lab: Query with SQL (Databricks)

-- COMMAND ----------

-- MAGIC %md
-- MAGIC ## Question 1
-- MAGIC Read the Unity Catalog table named "shared.data.reviews" into a dataframe. Call it "reviews".
-- MAGIC
-- MAGIC (In SQL, we can query the table directly or create a view for convenience.)

-- COMMAND ----------

CREATE OR REPLACE TEMP VIEW reviews AS
SELECT * FROM shared.data.reviews
